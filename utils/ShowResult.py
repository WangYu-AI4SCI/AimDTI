...
def show_result(DATASET, Accuracy_List, Precision_List, Recall_List, AUC_List, AUPR_List, save_path, Ensemble=False):
    ...
    if Ensemble == False:
        ...
        filepath = save_path + "/results.txt"
    else:
        print("The ensemble model's results:")
        filepath = save_path + "/ensemble_results.txt"
